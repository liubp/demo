package net.biocloud.jhipster.web.rest;

import net.biocloud.jhipster.config.Constants;
import com.codahale.metrics.annotation.Timed;
import net.biocloud.jhipster.domain.Authority;
import net.biocloud.jhipster.domain.User;
import net.biocloud.jhipster.repository.AuthorityRepository;
import net.biocloud.jhipster.repository.UserRepository;
import net.biocloud.jhipster.security.AuthoritiesConstants;
import net.biocloud.jhipster.service.MailService;
import net.biocloud.jhipster.service.UserService;
import net.biocloud.jhipster.web.rest.dto.ManagedUserDTO;
import net.biocloud.jhipster.web.rest.util.HeaderUtil;
import net.biocloud.jhipster.web.rest.util.PaginationUtil;
